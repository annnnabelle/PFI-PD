...
<main class="enigme-background">
    ...
    <div class="img-enigme-difficulter">
        <form action="/enigme-questions" method="post">
            <button type="submit" name="difficulte" value="F">
                <img src="public/img/Legend_II.png" alt="catfish">
                <p>Facile</p>
            </button>
            <button type="submit" name="difficulte" value="M">
                <img src="public/img/Son_of_Crimsonfish.png" alt="flounder">
                <p>Moyen</p>
            </button>
            <button type="submit" name="difficulte" value="D">
